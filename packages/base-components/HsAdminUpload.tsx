...
import { TOKEN, getItem, message } from '@hs-admin/utils'
...
const HsAdminUpload: FC<Props> = (props: Props) => {
  ...
  const uploadProps: any = useMemo(
    () => ({
      action: action || `${import.meta.env.VITE_BUSINESS_API_URL}/api/datamarket/file/upload`,
      headers: {
...
export default memo(HsAdminUpload)
